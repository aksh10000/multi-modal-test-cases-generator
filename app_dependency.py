...
def describe(query:str,images):
    ...
    for i,image_file in enumerate(images):
        prompt = f'''You are an AI assistant specializing in software quality assurance. Your task is to analyze screenshots of an app and generate detailed test cases. Each test case should include a description, pre-conditions, testing steps, and expected results.
Instructions:
